...
export interface PropertyDocblockDescribedTagFixtureMutators
{
    /** Old-style accessor named after the trailing word of this trait's own $-less tag's description. */
    list: unknown[];
}

export interface PropertyDocblockDescribedTagFixtureAll extends PropertyDocblockDescribedTagFixture, PropertyDocblockDescribedTagFixtureMutators {}
