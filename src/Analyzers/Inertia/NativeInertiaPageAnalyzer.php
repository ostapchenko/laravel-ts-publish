...
/**
 * Engine-backed replacement for InertiaPageAnalyzer's Surveyor path: reads a controller action's
 * Inertia render calls with the shared AST engine and types their props through the controller
 * handler profile.
 *
 * @phpstan-import-type TsCastsUnpacked from TsCastsReader
 * @phpstan-import-type InertiaPageData from InertiaPageAnalyzer
 *
 * @phpstan-type PagePropEntry = array{type: string, optional: bool}
 * @phpstan-type PagePropMap = array<string, PagePropEntry>
 */
class NativeInertiaPageAnalyzer
{
